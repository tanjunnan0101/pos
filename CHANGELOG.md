...
- **Smoke test:** `test:feedback-public-i18n` checks **de**, **fr**, **es**, **ca**, **zh-CN**, **hi**, `?token=` URL, and invalid **`/feedback/0`** after **en** (document title + visible copy, no raw `FEEDBACK.*` in the DOM) (GitHub #67).
