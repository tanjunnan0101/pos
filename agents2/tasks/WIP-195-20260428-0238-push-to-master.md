...
**Handoff (`012-feature-coder-handoff`, 2026-04-29):** Renamed **`WIP-195-20260428-0238-push-to-master.md`** → **`UNTESTED-195-20260428-0238-push-to-master.md`**. Coder **Implementation summary** documents completed **`development` → `master`** merge and **`origin/master`** push; end-to-end release still depends on a **green** **Deploy to amvara9** run (or **§4** manual parity). Issue **#195**: label **`agent:untested`** applied via **`gh issue edit`.**
