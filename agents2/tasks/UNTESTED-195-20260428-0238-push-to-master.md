...
**Handoff (`012-feature-coder-handoff.md`, 2026-04-30 — executed):** After **`./scripts/git-sync-development.sh`**, coder implementation is complete per **Implementation summary** and **TASKS-README.md** (**wip → untested**: implementation done + **Testing instructions** present). **Testing instructions** appear in this file (search **`## Testing instructions`** — canonical steps after historical test reports). Renamed **`WIP-195-20260428-0238-push-to-master.md`** → **`UNTESTED-195-20260428-0238-push-to-master.md`**; **`gh issue edit 195 --add-label "agent:untested"`** and **`--remove-label "agent:wip"`** applied. **Tester:** rename **`UNTESTED-…` → `TESTING-…`** when verification starts; criterion **(2)** may still **FAIL** until secrets + green **`master`** **Deploy to amvara9** or documented **§4** parity.
